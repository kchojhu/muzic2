System.register(['./Rx', './add/observable/dom/ajax', './add/observable/dom/webSocket', './observable/dom/AjaxObservable', './scheduler/asap', './scheduler/async', './scheduler/queue', './scheduler/animationFrame'], function(exports_1) {
