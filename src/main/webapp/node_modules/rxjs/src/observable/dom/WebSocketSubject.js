System.register(['../../Subject', '../../Subscriber', '../../Observable', '../../Subscription', '../../util/root', '../../ReplaySubject', '../../util/tryCatch', '../../util/errorObject', '../../util/assign'], function(exports_1) {
            ...
            WebSocketSubject = (function (_super) {
                ...
                WebSocketSubject.prototype._subscribe = function (subscriber) {
                    ...
                    if (self.url && !self.socket) {
                        var socket = self.protocol ? new WebSocket(self.url, self.protocol) : new WebSocket(self.url);
                        self.socket = socket;
                        socket.onopen = function (e) {
                            ...
                            self.destination = Subscriber_1.Subscriber.create(function (x) { return socket.readyState === 1 && socket.send(x); }, function (e) {
                        ...
                        socket.onerror = function (e) { return self.error(e); };
