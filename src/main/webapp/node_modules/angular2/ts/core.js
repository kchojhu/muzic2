System.register(['./src/core/metadata', './src/core/util', './src/core/prod_mode', './src/core/di', './src/facade/facade', 'angular2/src/facade/lang', './src/core/application_ref', './src/core/application_tokens', './src/core/zone', './src/core/render', './src/core/linker', './src/core/debug/debug_node', './src/core/testability/testability', './src/core/change_detection', './src/core/platform_directives_and_pipes', './src/core/platform_common_providers', './src/core/application_common_providers', './src/core/reflection/reflection'], function(exports_1) {
    var exportedNames_1 = {
        ...
        'createPlatform': true,
        'assertPlatform': true,
        'disposePlatform': true,
        'getPlatform': true,
        'coreBootstrap': true,
        'coreLoadAndBootstrap': true,
        'createNgZone': true,
        'PlatformRef': true,
        'ApplicationRef': true,
        'APP_ID': true,
    ...
    return {
        setters:[
            ...
            function (application_ref_1_1) {
                exports_1({
                    "createPlatform": application_ref_1_1["createPlatform"],
                    "assertPlatform": application_ref_1_1["assertPlatform"],
                    "disposePlatform": application_ref_1_1["disposePlatform"],
                    "getPlatform": application_ref_1_1["getPlatform"],
                    "coreBootstrap": application_ref_1_1["coreBootstrap"],
                    "coreLoadAndBootstrap": application_ref_1_1["coreLoadAndBootstrap"],
