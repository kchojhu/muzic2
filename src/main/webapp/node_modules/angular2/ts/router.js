 ...
 */
System.register(['./src/router/router', './src/router/directives/router_outlet', './src/router/directives/router_link', './src/router/instruction', './src/router/route_registry', './src/router/route_config/route_config_decorator', './src/router/route_definition', './src/router/lifecycle/lifecycle_annotations', 'angular2/core', 'angular2/src/router/router_providers_common', 'angular2/src/router/router_providers', './src/facade/lang'], function(exports_1) {
