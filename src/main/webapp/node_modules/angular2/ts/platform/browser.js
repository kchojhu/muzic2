System.register(['angular2/src/core/angular_entrypoint', 'angular2/src/platform/browser_common', 'angular2/src/facade/lang', 'angular2/compiler', 'angular2/core', 'angular2/src/core/reflection/reflection_capabilities', "angular2/src/platform/browser/xhr_impl", 'angular2/src/core/di'], function(exports_1) {
    ...
    var exportedNames_1 = {
        'BROWSER_APP_PROVIDERS': true,
        'browserPlatform': true,
        'bootstrap': true,
        'BROWSER_PROVIDERS': true,
        'CACHED_TEMPLATE_PROVIDER': true,
        'ELEMENT_PROBE_PROVIDERS': true,
        'ELEMENT_PROBE_PROVIDERS_PROD_MODE': true,
        'inspectNativeElement': true,
        'BrowserDomAdapter': true,
        'By': true,
        'Title': true,
        'DOCUMENT': true,
        'enableDebugTools': true,
        'disableDebugTools': true
    };
    ...
    return {
        setters:[
            function (angular_entrypoint_1_1) {
                exportStar_1(angular_entrypoint_1_1);
            },
