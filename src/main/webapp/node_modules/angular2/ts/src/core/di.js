 ...
 */
System.register(['./di/metadata', './di/decorators', './di/forward_ref', './di/injector', './di/reflective_injector', './di/provider', './di/reflective_provider', './di/reflective_key', './di/reflective_exceptions', './di/opaque_token'], function(exports_1) {
    var exportedNames_1 = {
        'InjectMetadata': true,
