System.register(['./linker/component_resolver', './linker/query_list', './linker/dynamic_component_loader', './linker/element_ref', './linker/template_ref', './linker/view_ref', './linker/view_container_ref', './linker/component_factory', './linker/exceptions'], function(exports_1) {
    return {
        setters:[
