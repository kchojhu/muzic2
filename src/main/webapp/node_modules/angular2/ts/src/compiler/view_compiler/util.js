System.register(['angular2/src/facade/lang', 'angular2/src/facade/exceptions', '../output/output_ast', '../identifiers'], function(exports_1) {
    ...
    function getPropertyInView(property, callingView, definedView) {
        if (callingView === definedView) {
            ...
            if (property instanceof o.ReadPropExpr) {
                ...
                if (definedView.fields.some(function (field) { return field.name == readPropExpr.name; }) ||
                    definedView.getters.some(function (field) { return field.name == readPropExpr.name; })) {
