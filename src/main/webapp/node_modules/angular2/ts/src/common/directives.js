System.register(['./directives/ng_class', './directives/ng_for', './directives/ng_if', './directives/ng_template_outlet', './directives/ng_style', './directives/ng_switch', './directives/ng_plural', './directives/observable_list_diff', './directives/core_directives'], function(exports_1) {
    var exportedNames_1 = {
        'NgClass': true,
        'NgFor': true,
        'NgIf': true,
    ...
    return {
        setters:[
            ...
            function (ng_template_outlet_1_1) {
                exports_1({
                    "NgTemplateOutlet": ng_template_outlet_1_1["NgTemplateOutlet"]
                });
            },
